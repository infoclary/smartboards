	...
	<div class="row ">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img1">
				<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
					...
					<img class="img-responsive img-boton1" src="<?php bloginfo('template_url'); ?>/images/botton.png" alt="pantallas interactivas">
					</a>
				</div>
				<div class="col-lg-2 col-md-2 hidden-sm hidden-xs o">
					<img class="img-responsive " src="<?php bloginfo('template_url'); ?>/images/o.png" alt="tableros digitales">
				</div>
				<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 llam">
					<p class="llamada">LLAMANOS 547 35 89</p>
...
$destinatario = "miguel@claryla.com,cristian@claryla.com,alejandro@claryla.com"; 
$asunto = "smartboards.com.co"; 
$cuerpo = ' 
<html> 
<head> 
   <title>Nuevo dato desde Smart Boards</title> 
</head> 
<body> 
<h1>Smart Boards (Colombia)</h1>
 <p>Nombre:</p>
<p>'.$_POST["nombre"].'</p>
 <p>Email:</p>
<p>'.$_POST["email"].'</p>
