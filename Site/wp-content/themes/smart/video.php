...
*/
  ?><div class="">
					...
					<img class="img-responsive" src="<?php bloginfo('template_url'); ?>/images/demo.png" alt="pantallas interactivas para oficina">
					</a>
				...
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
							<input type="submit" name="submit6" value="Contactanos" class="boton" onclick="clic()">
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12"></div>
					</div>
					</form>	
...
<html> 
<head> 
   <title>Nuevo dato desde smartboards.com.co</title> 
</head> 
<body> 
